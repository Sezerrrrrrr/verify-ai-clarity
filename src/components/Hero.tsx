  ...
  return <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-20 md:pt-0">
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="max-w-4xl mx-auto text-center text-white">
          {/* Trust badge */}
          <div className="inline-flex items-center gap-1.5 md:gap-2 bg-white/20 backdrop-blur-sm border border-white/40 rounded-full px-3 py-1.5 md:px-4 md:py-2 mb-8 animate-fade-in shadow-lg hover:bg-white/25 transition-all hover:scale-105" style={{ animationDelay: '100ms' }}>
            <Shield className="w-3 h-3 md:w-4 md:h-4 text-white" />
            <span className="text-xs md:text-sm font-semibold">SOC2 & HIPAA Compliant</span>
          </div>
          
          {/* Heading */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight animate-fade-in" style={{ animationDelay: '200ms' }}>
            Save 200+ Hours Monthly on Insurance Verification With AI
          </h1>
          
          {/* Description */}
          <p className="text-base md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '300ms' }}>Our AI agent calls your patients' insurances to verify eligibility and covering details, saving you time and money - for $2/successful verification</p>
          
          {/* Audio Player */}
          <div className="flex justify-center mb-8 animate-fade-in" style={{ animationDelay: '400ms' }}>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 animate-fade-in px-4" style={{ animationDelay: '500ms' }}>
          ...
          {/* Social proof */}
          <div className="flex flex-row items-center justify-center gap-3 sm:gap-6 text-white/80 animate-fade-in" style={{ animationDelay: '700ms' }}>
