              ...
              <TooltipProvider>
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input id="dailyHours" type="number" step="0.5" placeholder="Add Numeric Value" value={dailyHours} onChange={e => setDailyHours(e.target.value)} className="text-lg max-w-[120px]" />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input id="hourlyRate" type="number" step="1" placeholder="Add Numeric Value" value={hourlyRate} onChange={e => setHourlyRate(e.target.value)} className="pl-7 text-lg max-w-[120px]" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input id="dailyPatients" type="number" step="1" placeholder="Add Numeric Value" value={dailyPatients} onChange={e => setDailyPatients(e.target.value)} className="text-lg max-w-[120px]" />
                  </div>
